namespace SE3.Utils
{
    public class BinarySave
    {
        ...
        public BinarySave(Dictionary<string, object> defaut)
        {
            data = defaut;
        }
        ...
        public static BinarySave Load(string fileName, Dictionary<string, object> defaut)
        {
            BinarySave temp = new BinarySave(defaut);
            temp.Load(fileName);
            return temp;
        }
